...
public class Calculator {
	...
	/**all the required fields or variables**/
	
	//result contains final result
	//expression is taken  up during the clicking of buttons separated by comma so that we can find tokens easily by , delimeter
